...
@section('content')
    <div id="content-list" class="box box-primary box-table box-table-image">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-list"></i> Letters List</h3>
            <div class="box-tools pull-right">
                ...
                <ul class="dropdown-menu">
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ route('admin.project.index') }}">Letters</a></li>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var table = $('#content-table').DataTable({
                ...
                ajax: {
                    url: '{{ route("admin.api.letter.index") }}',
                    type: 'post',
                ...
                fnInitComplete:function(){
                    $('.dataTables_filter').append(`
                        <a href="{{ route('admin.letter.create') }}" class="btn btn-sm btn-flat btn-success"><i class="fa fa-plus"></i> Create</a>
                    `);
                    $('#content-list').find('.overlay').remove();
