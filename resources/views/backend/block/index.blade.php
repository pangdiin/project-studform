        ...
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                ...
                <ul class="dropdown-menu">
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ route('admin.block.index') }}">Blocks</a></li>
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ route('admin.block.deleted') }}">Deleted</a></li>
                </ul>
            </div>
        </div>
        <div class="box-body">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var table = $('#content-table').DataTable({
                ...
                ajax: {
                    url: '{{ route("admin.api.block.index") }}',
                    type: 'post',
                ...
                fnInitComplete:function(){
                    $('.dataTables_filter').append(`
                        <a href="{{ route('admin.block.create') }}" class="btn btn-sm btn-flat btn-success"><i class="fa fa-plus"></i> Create</a>
                    `);
                    $('#content-list').find('.overlay').remove();
