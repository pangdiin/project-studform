<div class="box box-success">
    ...
    <div class="box-body">
        ...
        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
            <div class="fileinput fileinput-new" data-provides="fileinput">
                <div class="fileinput-new thumbnail" >
                    <img src={{ isset($product) ? $product->imagePath : url('img/no-image.png') }}>
                </div>
        ...
        <div class="form-group{{ $errors->has('thumbnail') ? ' has-error' : '' }}">
            <div class="fileinput fileinput-new" data-provides="fileinput">
                <div class="fileinput-new thumbnail" >
                    <img  src={{ isset($product) ? url($product->thumbnail) : url('img/no-image.png') }}>
                </div>
                <div class="fileinput-preview fileinput-exists thumbnail" ></div>
                <div class="text-center">
                    <span class="btn btn-primary btn-flat btn-file text-center">
                        <span class="fileinput-new">Select Product Thumbnail</span>
                        <span class="fileinput-exists">Change</span>
