...
@section('content')
    <div id="content-list" class="box box-primary box-table box-table-image">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-list"></i> Project List</h3>
            ...
            var table = $('#content-table').DataTable({
                ...
                fnInitComplete:function(){
                    $('.dataTables_filter').append(`
                        <a href="{{ route('admin.project.create') }}" class="btn btn-sm btn-flat btn-success"><i class="fa fa-plus"></i> Create</a>
                    `);
                    $('#content-list').find('.overlay').remove();
