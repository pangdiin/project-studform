...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value is the company name that created your application. This value is used when the
    | framework needs to place the application's company name in a notification or
    | any other location as required by the application or its packages.
    */

    'company' => [

        'name' => 'Red Starfish Web Design',
        
        'link' => 'https://redstarfishwebdesign.com'
    ],
